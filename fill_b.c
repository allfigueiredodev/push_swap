...
/*   Updated: 2023/10/17 16:41:09 by aperis-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	rotate_down_both(t_dclist *cheapest, t_dclist **stack_a,
		t_dclist **stack_b)
{
...
void	rotate_up_both(t_dclist *cheapest, t_dclist **stack_a,
		t_dclist **stack_b)
{
	if (cheapest->target->index != 0 && cheapest->index != 0)
	{
...
void	rotate_oposite_direction_a(t_dclist *cheapest, t_dclist **stack_a,
		t_dclist **stack_b)
{
	if (cheapest->target->index != 0 || cheapest->index != 0)
	{
...
void	rotate_oposite_direction_b(t_dclist *cheapest, t_dclist **stack_a,
		t_dclist **stack_b)
{
	if (cheapest->target->index != 0 || cheapest->index != 0)
	{
